// Real unDraw illustrations (MIT licensed, https://undraw.co), sourced verbatim
// from the undraw-svg package and adapted to JSX. Their recolorable primary
// shape keeps `fill="currentColor"` so it inherits `color` from CSS -- set
// `color: var(--accent-bright)` (or similar) on a wrapping element to theme it.
import type { SVGProps } from "react";

export function SecurityOnIllustration(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 799.468 552.327" aria-hidden="true" {...props}>
      <g transform="translate(-560.266 -263.837)">
        ...
        <g transform="translate(0 36.84)">
          ...
          <g transform="translate(40 16)">
            ...
            <circle cx="14.5" cy="14.5" r="14.5" transform="translate(927 626)" fill="currentColor" />
          </g>
        </g>
      </g>
    </svg>
